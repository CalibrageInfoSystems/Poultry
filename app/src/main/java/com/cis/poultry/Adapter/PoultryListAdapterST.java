...
public class PoultryListAdapterST extends RecyclerView.Adapter<PoultryListAdapterST.MyViewHolder> {
    ...
    public PoultryListAdapterST(Context context, List<LoginResponse.Result.UserFarm> request_List) {
...
//                }
                ...
                StockFragment bookFragment = new StockFragment();
