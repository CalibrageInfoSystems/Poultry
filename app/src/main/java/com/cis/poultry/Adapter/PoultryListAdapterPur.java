...
public class PoultryListAdapterPur extends RecyclerView.Adapter<PoultryListAdapterPur.MyViewHolder> {
    ...
    public PoultryListAdapterPur(Context context, List<LoginResponse.Result.UserFarm> request_List) {
...
//                }
                ...
                PursageFragment bookFragment = new PursageFragment();
