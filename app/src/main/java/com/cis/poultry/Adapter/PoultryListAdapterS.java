...
public class PoultryListAdapterS extends RecyclerView.Adapter<PoultryListAdapterS.MyViewHolder> {
    ...
    public PoultryListAdapterS(Context context, List<LoginResponse.Result.UserFarm> request_List) {
...
//                }
                ...
                SaleFragment bookFragment = new SaleFragment();
