...
public class PoultryListAdapter extends RecyclerView.Adapter<PoultryListAdapter.MyViewHolder> {
    ...
    public PoultryListAdapter(Context context, List<LoginResponse.Result.UserFarm> request_List) {
...
//                }
               //two text views defined on top of the viewHolder
                ...
                HomeFragment bookFragment = new HomeFragment();
