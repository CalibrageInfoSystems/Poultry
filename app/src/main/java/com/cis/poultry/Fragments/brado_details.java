 ...
 * {@link brado_details.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link brado_details#newInstance} factory method to
 * create an instance of this fragment.
 */
public class brado_details extends BaseFragment {
    ...
    public static brado_details newInstance(String param1, String param2) {
        brado_details fragment = new brado_details();
    ...
    private void setviews() {
        ...
        Log.e("dates==========>brado",SaleFragment.startDateformatted+SaleFragment.endDateformatted+"id===================="+traderId);
...
//        Log.e("date=========22", SaleFragment.endDateformatted);
                    ...
                    public void onNext(EggSaleresponse eggSaleresponse) {
                        ...
                        if (eggSaleresponse.getIsSuccess()) {
                            ...
                            for (EggSaleresponse.Result.SaleRegisterDetail listResult :
                                ...
                                if (listResult.getTraderId() == 1002)
    ...
    private BroadcastReceiver mNotificationReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            editor.commit();
            Log.e("bradoadates==========>",to_date+"============"+from_date+"id===================="+traderId);
            Log.e("dates==========>",SaleFragment.startDateformatted+SaleFragment.endDateformatted+"id===================="+traderId);
            GetEggSaleDetails();
        }
    };
...
//
        ...
        eggSaleObject.setTraderId(traderId);
        if(SaleFragment.startDateformatted!=null && !SaleFragment.startDateformatted.isEmpty() && !SaleFragment.startDateformatted.equals("null")) {
