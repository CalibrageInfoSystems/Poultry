 ...
 * {@link jayamadurga_fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link jayamadurga_fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class jayamadurga_fragment extends Fragment {
    ...
    public static jayamadurga_fragment newInstance(String param1, String param2) {
        jayamadurga_fragment fragment = new jayamadurga_fragment();
...
//        Log.e("date=========22", SaleFragment.endDateformatted);
    ...
    private BroadcastReceiver mNotificationReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            editor.commit();
            Log.e("jayamadates==========>",to_date+"============"+from_date+"id===================="+traderId);
                ...
                .subscribe(new Subscriber<EggSaleresponse>() {
                    ...
                    public void onNext(EggSaleresponse eggSaleresponse) {
                        ...
                        if (eggSaleresponse.getIsSuccess()) {
                            ...
                            if(traderId.equalsIgnoreCase("1002")) {
                                if (listsaletrd2.size() != 0) {
...
//        }
    ...
    public void onResume() {
        super.onResume();
//        to_date= sharedPreferences.getString("todate","");
//        from_date= sharedPreferences.getString("fromdate","");
//        traderId= sharedPreferences.getString("v","");
      //  GetEggSaleDetails();
